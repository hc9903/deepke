...
for i in bad_tag:
    if i in tag_set3:
        tag_set3.remove(i)
tag_set3=tag_set3.union({'小说','书籍','植物','电影','教授','收藏家','游戏'})
f=open('data/long_tag.txt','w',encoding='utf8')
for i in tag_set3:
    f.write(i+'\n')
f.close()


tags = open('data/name_shuffled.txt',encoding='utf-8')
tag_set1={i.strip() for i in tags}
tags.seek(0)
tag_set2={i.strip() for i in tags}
tags.seek(0)
...
f=open('data/long_name.txt','w',encoding='utf8')
for i in tag_set3:
    f.write(i+'\n')
